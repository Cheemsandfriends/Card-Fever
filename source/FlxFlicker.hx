...
class FlxFlicker implements IFlxDestroyable
{
	...
	static var _boundValues:Map<Dynamic, FlxFlicker> = new Map<Dynamic, FlxFlicker>();
    ...
    public static function flickerValue(Object:Dynamic, Value:String, Values:Array<Dynamic>, Duration:Float = 1, Interval:Float = 0.04, 
        EndVisibility:Bool = true, ForceRestart:Bool = true,?CompletionCallback:FlxFlicker->Void, ?ProgressCallback:FlxFlicker->Void):FlxFlicker
    {
		if (isValueFlickering(Object))
		{
			if (ForceRestart)
			{
				stopValueFlickering(Object);
			}
			else
			{
				// Ignore this call if object is already flickering.
        ...
        var flicker:FlxFlicker = _pool.get();
		flicker.startValue(Object, Value, Values, Duration, Interval, EndVisibility, CompletionCallback, ProgressCallback);
		return _boundValues[Object] = flicker;
    }
	/**
    ...
    public static function isValueFlickering(Object:Dynamic):Bool
	{
		return _boundValues.exists(Object);
	}
    ...
    public static function stopValueFlickering(Object:Dynamic):Void
	{
		var boundFlicker:FlxFlicker = _boundValues[Object];
		if (boundFlicker != null)
		{
			boundFlicker.stop();
		}
    ...
    function startValue(Object:Dynamic, Value:String, Values:Array<Dynamic>, Duration:Float, Interval:Float, EndVisibility:Bool, ?CompletionCallback:FlxFlicker->Void,
			?ProgressCallback:FlxFlicker->Void):Void
	{
		object = Object;
		duration = Duration;
    ...
    function flickerValueProgress(Timer:FlxTimer):Void
	{
        var i = Timer.elapsedLoops % 2;
